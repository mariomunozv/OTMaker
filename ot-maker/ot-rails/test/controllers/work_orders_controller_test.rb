...
class WorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post :create, work_order: { bill_order_id: @work_order.bill_order_id, code: @work_order.code, description: @work_order.description, organization_id: @work_order.organization_id, title: @work_order.title, user_id: @work_order.user_id }
    end
  ...
  test "should update work_order" do
    patch :update, id: @work_order, work_order: { bill_order_id: @work_order.bill_order_id, code: @work_order.code, description: @work_order.description, organization_id: @work_order.organization_id, title: @work_order.title, user_id: @work_order.user_id }
    assert_redirected_to work_order_path(assigns(:work_order))
  end
